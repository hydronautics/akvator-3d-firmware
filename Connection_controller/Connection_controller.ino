...
// Они лежат в папке "Палта GROV-2013/Arduino/libraries/I2CHeaders" 
// libraries - это специальная папка, где можно хранить пользовательские библиотеки
// Эти header файлы можно подключить из любого скетча, лежащего внутри папки "Палта GROV-2013/Arduino", при этом их адреса заключаются в угловые скобки вместо кавычек
