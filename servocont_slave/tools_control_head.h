...
#define FIRST_SERVO_MIDDLE 98 // Среднее положение сервок манипулятора.Лопатка.0 - max право,180 - max лево 

#define SECOND_SERVO_MIDDLE 105 // Среднее положение сервок манипуляторов.Плечо. 0 - max верх, 180 - max - вниз

#define THIRD_SERVO_MIDDLE 100 // Среднее положение сервок манипуляторов.Кисть. 0 - max вниз,180 max вверх
